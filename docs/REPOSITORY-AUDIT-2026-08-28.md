...
The history explicitly records governance files being added and subsequently reverted as mistakenly added. The repository should retain that fact as an audit event rather than hide it.
